...
The EC2 instance was set up, and the Docker images were transferred to it. The app was then run inside the Docker container on the EC2 instance, making it accessible via the public IP
